...
function CreateFontData() {
  ...
  addChar('!', [0., .4, 0., -.125], [0., -.375, 0., -.375]);
  addChar('"', [-.125, .4, -.125, .25], [.125, .4, .125, .25]);
  addChar('#', [-.275, .2, .375, .2], [-.375, -.2, .275, -.2], [-.3, -.375, -.1, .4], [.1, -.375, .3, .4]);
  addChar('$', [-.375, .3, .375, .3], [-.375, 0., .375, -0.], [-.375, -.25, .375, -.25], [-.375, .3, -.375, 0.], [.375, -.25, .375, 0.], [0., .4, 0., -.375]);
  addChar('%', [-.275, .15, -.275, .15], [.275, -.375, .275, -.375], [-.2, -.375, .25, .2]);
  addChar('&', [.4, -.4, -.25, .2], [-.25, .2, 0., .375], [0., .375, .25, .2], [.25, .2, -.3, -.2], [-.3, -.2, 0., -.4], [0., -.4, .4, -.125]);
  addChar('\'', [0., .4, 0., .25]);
  addChar('(', [0., .4, -.125, 0.], [-.125, 0., 0., -.375]);
  addChar(')', [0., .4, .125, 0.], [.125, 0., 0., -.375]);
  addChar('*', [0., .375, 0., .375], [0., .4, 0., .4], [-.075, .35, -.075, .35], [.075, .35, .075, .35], [-.075, .3, -.075, .3], [.075, .3, .075, .3], [0., .25, 0., .25]);
  addChar('+', [0., .375, 0., -.375], [.375, 0., -.375, 0.]);
  addChar(',', [.1, -.25, 0., -.4]);
  addChar('-', [-.3, 0., .3, 0.]);
  addChar('.', [0., -.375, 0., -.375]);
  addChar('/', [-.25, -.375, .25, .375]);
  addChar('0', [-.375, -.4, -.375, .4], [.375,  -.4, .375,  .4], [-.375,  .4,  .375, .4], [-.375, -.4, .375, -.4], [-.375, -.4, .375, .4]);
  addChar('1', [0., -.4, 0., .4], [0., .4, -.125, .3]);
  addChar('2', [-.375, .4, .375, .4], [-.375, 0., .375, 0.], [-.375, -.375, .375, -.375], [-.375, 0., -.375, -.375], [.375, 0., .4, .375]);
  addChar('3', [.375, .4, .375, -.375], [-.375, .4, .375, .4], [-.25, 0., .375, 0.], [-.375, -.375, .375, -.375], );
  ...
  addChar(':', [0., -.375, 0., -.375], [0., 0., 0., 0.]);
  addChar(';', [0., -.25, -.1, -.4], [0., 0., 0., 0.]);
  addChar('<', [.25, .375, -.25, 0.], [-.25, 0., .25, -.375]);
  addChar('=', [-.375, .2, .375, .2], [-.375, -.2, .375, -.2]);
  addChar('>', [-.25, .375, .25, 0.], [.25, 0., -.25, -.375]);
  addChar('?', [-.25, .4, .25, .4], [.25, .4, .25, .0], [.25, .0, -.125, .0], [-.125, .0, -.125, -.1], [-.125, -.375, -.125, -.375]);
  addChar('@', [.375, -.375, -.375, -.375], [-.375, -.375, -.375, .4], [-.375, .4, .375, .4], [.375, .4, .375, -.125], [.375, -.125, -.125, -.125], [-.125, -.125, -.125, .2], [-.125, .2, .125, .2], [.125, .2, .125, -.125]);
  ...
  addChar('X', [-.375, -.375, .375, .4], [-.375, .4, .375, -.375]);
  addChar('Y', [-.375, -.5, .375, .4], [-.375, .4, 0., 0.]);
  addChar('Z', [-.375, -.4, .375, -.4], [-.375, .4, .375, .4], [-.375, -.4, .375, .4]);
  addChar('[', [-.125, .4, .125, .4], [-.125, .4, -.125, -.375], [-.125, -.375, .125, -.375]);
  addChar('\\', [-.25, .4, .25, -.375]);
  addChar(']', [-.125, .4, .125, .4], [.125, .4, .125, -.375], [-.125, -.375, .125, -.375]);
  addChar('^', [-.25, .25, 0., .4], [0., .4, .25, .25]);
  addChar('_', [-.375, -.375, .375, -.375]);
  addChar('`', [-.1, .4, 0., .25]);
  addChar('a', [-.2, .2, .25, .2], [.25, .2, .25, -.375], [.25, -.375, -.25, -.375], [-.25, -.375, -.25, 0.], [-.25, 0., .25, 0.]);
  addChar('b', [-.25, .1, .25, .1], [-.25, .4, -.25, -.375], [-.25, -.375, .25, -.375], [.25, -.375, .25, .1]);
  addChar('c', [-.2, .15, .2, .2], [-.2, .15, -.2, -.325], [-.2, -.325, .2, -.375]);
  addChar('d', [-.25, .1, .25, .1], [-.25, .1, -.25, -.375], [-.25, -.375, .25, -.375], [.25, -.375, .25, .4]);
  addChar('e', [-.25, -.1, .25, -.1], [.25, -.1, 0., .25], [0., .25, -.25, -.1], [-.25, -.1, -.1, -.375], [-.1, -.375, .25, -.375]);
  addChar('f', [.125, .4, 0., .3], [0., .3, 0., -.4], [-.125, 0., .125, 0.]);
  addChar('g', [-.2, .25, .25, .25], [-.2, 0., .2, 0.], [-.2, .25, -.2, 0.], [.2, .25, .2, -.4], [.2, -.4, -.3, -.4], [-.3, -.4, -.3, -.2], [-.3, -.2, .25, -.2]);
  addChar('h', [-.25, .4, -.25, -.375], [-.25, 0., .25, 0.], [.25, 0., .25, -.375]);
  addChar('i', [0., .3, 0., .3], [0., -.375, 0., 0.]);
  addChar('j', [.1, .35, .1, .35], [.1, -.375, .1, .05], [.1, -.375, 0., -.45]);
  addChar('k', [-.25, .4, -.25, -.375], [-.25, -.2, .2, .125], [-.1, -.1, .25, -.375]);
  addChar('l', [-.125, .4, -.125, -.3], [-.125, -.3, 0., -.375]);
  addChar('m', [-.25, .15, .25, .15], [-.25, .15, -.25, -.375], [0., .15, 0., -.375], [.25, .15, .25, -.375]);
  addChar('n', [-.2, .15, .2, .15], [-.2, .15, -.2, -.375], [.2, .15, .2, -.375]);
  addChar('o', [-.25, .2, .25, .2], [-.25, .2, -.25, -.375], [.25, .2, .25, -.375], [-.25, -.375, .25, -.375]);
  addChar('p', [-.2, .2, .2, .2], [-.2, .2, -.2, -.45], [.2, .2, .2, -.1], [-.2, -.1, .2, -.1]);
  addChar('q', [-.2, .2, .2, .2], [.2, .2, .2, -.45], [-.2, .2, -.2, -.1], [-.2, -.1, .2, -.1], [.125, -.3, .275, -.3]);
  addChar('r', [-.15, .2, -.15, -.375], [-.15, .15, .15, .2]);
  addChar('s', [-.25, .25, .25, .25], [-.25, .25, -.25, -.05], [-.25, -.05, .25, -.05], [.25, -.05, .25, -.375], [-.25, -.375, .25, -.375]);
  addChar('t', [-.125, .4, -.125, -.3], [-.125, -.3, 0., -.375], [-.25, 0., 0., 0.]);
  addChar('u', [-.25, .25, -.25, -.375], [-.25, -.375, .25, -.3], [.25, .25, .25, -.375]);
  addChar('v', [-.25, .25, 0., -.375], [.25, .25, 0., -.375]);
  addChar('w', [-.3, .25, -.125, -.375], [-.125, -.375, 0., .125], [0., .125, .125, -.375], [.125, -.375, .3, .25]);
  addChar('x', [-.25, -.375, .25, .25], [-.25, .25, .25, -.375]);
  addChar('y', [.3, .25, -.25, -.45], [-.3, .25, -.1, -.1]);
  addChar('z', [-.25, .2, .25, .2], [.25, .2, -.25, -.375], [-.25, -.375, .25, -.375]);
  addChar('{', [-.125, .4, .125, .4], [-.125, .4, -.25, 0.], [-.25, 0., -.125, -.375], [-.125, -.375, .125, -.375]);
  addChar('|', [0., .4, 0., -.4]);
  addChar('}', [-.125, .4, .125, .4], [.125, .4, .25, 0.], [.25, 0., .125, -.375], [-.125, -.375, .125, -.375]);
  addChar('~', [-.375, -.05, -.125, .05], [-.125, .05, .125, -.05], [.125, -.05, .375, .05]);
  return letterLines;
}
